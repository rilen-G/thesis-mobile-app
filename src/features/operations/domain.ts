...
export type Product = { id: string; business_id: string; name: string; description: string; price_centavos: number; active: boolean; photo_path: string | null; version: number };
